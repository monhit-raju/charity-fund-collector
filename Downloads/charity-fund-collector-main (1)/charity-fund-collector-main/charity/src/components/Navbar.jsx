                        ...
                        <div className="col-md-8">
                            <div className="top-bar-left">
                                ...
                                <div className="text">
                                    ...
                                    <a href="tel:+91-9363616557"><p>+91-9363616557</p></a>
                                </div>
                                <div className="text">
                                    <i className="fa fa-envelope"></i>
                                    <a href="mailto:monhitraju.l2024aiml@sece.ac.in"><p>monhitraju.l2024aiml@sece.ac.in</p></a>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="top-bar-right">
                                <div className="social">
                                    <a href="https://x.com/SocialWelfare"><i className="fab fa-x-twitter"></i></a>
                                    <a href="https://www.facebook.com/dswdserves/"><i className="fab fa-facebook-f"></i></a>
                                    <a href="https://www.instagram.com/popular/social-welfare/"><i className="fab fa-instagram"></i></a>
                                    <a href="https://www.linkedin.com/company/berkeley-social-welfare/"><i className="fab fa-youtube"></i></a>
                                    <a href="https://www.linkedin.com/in/indian-social-welfare-society-gondia-1051aa243/"><i className="fab fa-linkedin-in"></i></a>
                                </div>
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div className="d-flex">
                            {auth.length === 0 && <Link to="/signup" className="btn btn-outline-warning me-2">Sign Up</Link>}
                        </div>
                    </div>
                </div>
            </div>
