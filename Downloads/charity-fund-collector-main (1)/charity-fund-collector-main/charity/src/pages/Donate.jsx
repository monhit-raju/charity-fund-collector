...
export default function Donate() {
    ...
    const fetchRecentLogin = async (auth, mail) => {
        var options = {
            method: 'GET',
            url: `${API_BASE_URL}/api/v1/registration/getLogs?email=${mail}`,
            headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isLogin) {
            ...
            var options = {
                method: 'POST',
                url: `${API_BASE_URL}/api/v1/donate/pay`,
                headers: {
    ...
    const handleEmail = async () => {
        ...
        if (regex.test(String(email).toLowerCase())) {
            try {
                const url = `${API_BASE_URL}/api/v1/registration?email=${String(email).toLowerCase()}`;
    ...
    const handleLogin = async () => {
        const options = {
            method: 'POST',
            url: `${API_BASE_URL}/api/v1/registration/auth`,
